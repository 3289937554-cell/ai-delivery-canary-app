...
installed_at: 2026-07-18T01:34:27Z
project_id: project-0007-ai-delivery-canary-app
control_mode: thin
pack_root: /Users/jiangli/总控库/软件开发/.worktrees/application-experience-gate
target_repo: /Users/jiangli/项目库/worktrees/GH-1-managed-status
registry_path: /Users/jiangli/总控库/软件开发/.worktrees/application-experience-gate/registry/projects.jsonl
...
```bash
python3 /Users/jiangli/总控库/软件开发/.worktrees/application-experience-gate/scripts/validate_ai_delivery_pack.py --enabled-repo --repo-root /Users/jiangli/项目库/worktrees/GH-1-managed-status
```

## Control-plane check command

```bash
python3 /Users/jiangli/总控库/软件开发/.worktrees/application-experience-gate/scripts/check_ai_delivery_target_repo.py --target-repo /Users/jiangli/项目库/worktrees/GH-1-managed-status
python3 /Users/jiangli/总控库/软件开发/.worktrees/application-experience-gate/scripts/check_ai_delivery_registry.py
```

## Bootstrap PR sequence

```bash
cd /Users/jiangli/项目库/worktrees/GH-1-managed-status
